export const INITIAL_DATA = {
  ...
  disbursements: [
    {id:'REQ-9901',emp:'EMP-0045 K. H. Min',ts:'2026-07-02 14:20',accrued:480000,requested:100000,fee:2500,debit:102500,net:97500,channel:'KBZPay Wallet',ref:'TXN-KBZ-88291',status:'DISBURSED',error:'None'},
    {id:'REQ-9902',emp:'EMP-0089 Poe Poe',ts:'2026-07-02 15:05',accrued:600000,requested:200000,fee:5000,debit:215000,net:195000,channel:'WavePay Wallet',ref:'TXN-WAV-11029',status:'DISBURSED',error:'None'},
    {id:'REQ-9903',emp:'EMP-0204 Kyaw Kyaw',ts:'2026-07-02 16:11',accrued:400000,requested:150000,fee:3750,debit:153750,net:146250,channel:'CB Bank Acc',ref:'None',status:'FAILED',error:'DEBIT_FIRST_FAIL'},
    {id:'REQ-9904',emp:'EMP-0301 Su Su Hlaing',ts:'2026-07-03 10:02',accrued:320000,requested:60000,fee:1500,debit:61500,net:58500,channel:'Wave Wallet',ref:'TXN-WAV-11208',status:'DISBURSED',error:'None'},
    {id:'REQ-9905',emp:'EMP-0410 Nilar Win',ts:'2026-07-03 13:44',accrued:260000,requested:260000,fee:6500,debit:266500,net:253500,channel:'CB Bank Acc',ref:'TXN-CB-30291',status:'PROCESSING',error:'None'},
    {id:'REQ-9906',emp:'EMP-0322 Zin Ko Ko',ts:'2026-07-04 09:15',accrued:210000,requested:80000,fee:2000,debit:82000,net:78000,channel:'KBZPay Wallet',ref:'TXN-KBZ-88705',status:'DISBURSED',error:'None'},
  ],
  batches: [
    {id:'BCH-5501',corp:'CORP-001 Shwe',cycle:'JUNE-2026',gl:'GL-CLR-0041',expected:512500,lateFees:9225,invoice:521725,received:521725,ref:'REF-99381.pdf',ts:'2026-07-01 10:00',coverage:100.0,suspense:0,status:'MATCHED'},
    {id:'BCH-5502',corp:'CORP-002 Nexa',cycle:'JUNE-2026',gl:'GL-CLR-0041',expected:800000,lateFees:24000,invoice:824000,received:500000,ref:'REF-11204.pdf',ts:'2026-07-02 11:15',coverage:60.67,suspense:0,status:'PARTIAL'},
    {id:'BCH-5503',corp:'CORP-001 Shwe',cycle:'JUNE-2026',gl:'GL-CLR-0041',expected:0,lateFees:0,invoice:0,received:50000,ref:'REF-44912.pdf',ts:'2026-07-02 16:30',coverage:0,suspense:50000,status:'SUSPENSE'},
    {id:'BCH-5504',corp:'CORP-003 Golden Irrawaddy',cycle:'JUNE-2026',gl:'GL-CLR-0041',expected:298000,lateFees:0,invoice:298000,received:298000,ref:'REF-77102.pdf',ts:'2026-07-03 09:40',coverage:100.0,suspense:0,status:'MATCHED'},
    {id:'BCH-5505',corp:'CORP-005 Yangon Textile',cycle:'JUNE-2026',gl:'GL-CLR-0041',expected:1240000,lateFees:41000,invoice:1281000,received:0,ref:'—',ts:'—',coverage:0,suspense:0,status:'MISSING'},
  ],
  budgetRequests: [
